...
namespace MediaBrowser.Channels.BlurN.Helpers
{
    ...
    public class TmdbMovieFindResult
    {
        public List<TmdbMovieSearchResult> movie_results { get; set; }
        public List<string> person_results { get; set; }
        public List<string> tv_results { get; set; }
        public List<string> tv_episode_results { get; set; }
        public List<string> tv_season_results { get; set; }
    }
}
